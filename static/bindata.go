...
func ConfigReadmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/README.md", size: 3031, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliAnonMetricNodeClientJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/anon-metric-node-client.json", size: 857, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliAnonMetricNodeServerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/anon-metric-node-server.json", size: 696, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliFleetEthProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.prod.json", size: 4470, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliFleetEthStagingJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.staging.json", size: 2145, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliFleetEthTestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.test.json", size: 2174, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliFleetWakuv2ProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-wakuv2.prod.json", size: 747, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliFleetWakuv2TestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-wakuv2.test.json", size: 748, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliLesEnabledJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/les-enabled.json", size: 58, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigCliMailserverEnabledJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/mailserver-enabled.json", size: 176, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func ConfigStatusChainGenesisJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/status-chain-genesis.json", size: 612, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func keysBootnodeKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/bootnode.key", size: 65, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func keysFirebaseauthkey() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/firebaseauthkey", size: 153, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func keysTestAccount1StatusChainPk() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/test-account1-status-chain.pk", size: 489, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func keysTestAccount1Pk() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/test-account1.pk", size: 491, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func keysTestAccount2StatusChainPk() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/test-account2-status-chain.pk", size: 489, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func keysTestAccount2Pk() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/test-account2.pk", size: 491, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
...
func keysTestAccount3BeforeEip55Pk() (*asset, error) {
	...
	info := bindataFileInfo{name: "keys/test-account3-before-eip55.pk", size: 489, mode: os.FileMode(0644), modTime: time.Unix(1644063591, 0)}
