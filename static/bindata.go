...
func ConfigReadmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/README.md", size: 3031, mode: os.FileMode(0644), modTime: time.Unix(1643364413, 0)}
...
func ConfigCliFleetEthStagingJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.staging.json", size: 1980, mode: os.FileMode(0644), modTime: time.Unix(1644840318, 0)}
